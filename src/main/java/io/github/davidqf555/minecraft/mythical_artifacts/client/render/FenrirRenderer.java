package io.github.davidqf555.minecraft.mythical_artifacts.client.render;
...
public class FenrirRenderer extends WolfRenderer {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(MythicalArtifacts.MOD_ID, "textures/entity/fenrir_entity.png");
